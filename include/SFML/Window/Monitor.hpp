...
public:
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Constructor from a platform monitor data snapshot
    ///
    ////////////////////////////////////////////////////////////
    explicit Monitor(const priv::MonitorImpl& impl);
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Get the OS-specific handle of the monitor
    ///
    /// The type of the returned handle is `sf::MonitorHandle`, which is
    /// a type alias to the handle type defined by the OS. You shouldn't
    ...
    /// workaround until a bug is fixed. It is only meaningful for the
    /// lifetime of this snapshot; see `sf::MonitorHandle` for details.
    ///
    /// \return System handle of the monitor
    ///
    ////////////////////////////////////////////////////////////
    [[nodiscard]] MonitorHandle getNativeHandle() const;
...
private:
    ////////////////////////////////////////////////////////////
    // Member data - a self-contained snapshot, not a live view
    ////////////////////////////////////////////////////////////
    String        m_name;
    String        m_identifier;
